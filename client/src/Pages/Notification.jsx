...
//   const { View } = useLottie(options);
  ...
  <div class="lg:w-2/5 sm:w-3/5 w-11/12 bg-gray-100 dark:bg-gray-800 rounded-xl mx-auto border p-10 shadow-sm">
    ...
    <p class="mt-8 font-medium text-gray-500 text-sm sm:text-base dark:text-white">New</p>
    ...
    <div class="mt-2 px-6 py-4 bg-white rounded-lg shadow w-full">
      <div class=" inline-flex items-center justify-between w-full">
        <div class="inline-flex items-center">
          <img
            ...
            alt="Form Icon" class="w-10 h-10 mr-3"/>
          <h3 class="font-bold text-base text-gray-800">Udne ki website</h3>
        </div>
      ...
      <p class="mt-1 text-sm">
        You are invited by sujigya
      </p>
      <button
                      className="btn btn-info mx-6 my-2 p-3 bg-cyan-300 text-black rounded-full"
                      
                    >
                      Accept
                    </button>
                    <button
                      className="btn btn-info p-3 bg-red-400 text-black rounded-full"
